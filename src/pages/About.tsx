  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-arial text-black-700 dark:text-black-400 mb-10 text-center">Beyond Engineering</h1>

        <section className="mb-12">
          <h2 className="text-2xl font-arial text-black-600 dark:text-black-300 mb-4">Adventure & Adrenaline</h2>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-arial text-black-600 dark:text-black-300 mb-4">Passions & Hobbies</h2>
        ...
        <section>
          <h2 className="text-2xl font-arial text-black-600 dark:text-black-300 mb-4">Moments Captured</h2>
